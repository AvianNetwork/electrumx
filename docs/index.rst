...
The project is hosted on `GitHub <https://github.com/AvianNetwork/electrumx>`_.

Please submit an issue on the `bug tracker
<https://github.com/AvianNetwork/electrumx/issues>`_ if you have found a
...
<https://github.com/AvianNetwork/electrumx/LICENCE>`_.
